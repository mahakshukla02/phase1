...
public class FileHandling
{
    public static void main(String args[]) throws FileNotFoundException, IOException {
        ...
        System.out.println(" WRITE for write mode ");
        System.out.println(" READ for read mode ");
        System.out.println(" APPEND for append mode ");
        ...
        else if(s.equalsIgnoreCase("WRITE")||s.equalsIgnoreCase("APPEND"))
        {
            writingToFile(s);   
        }
        else
        {
            System.out.println("Sorry something went wrong,betterluck next time ");
        }
